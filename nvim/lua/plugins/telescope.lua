return { -- Fuzzy Finder (files, lsp, etc)
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader>gcc', builtin.git_commits, { desc = 'Search [G]it [C]ommits' })
    ...
    end, { desc = '[S]each LSP [d]ocument symbols' })
    ...
    end, { desc = '[S]earch current [W]ord as filename' })
