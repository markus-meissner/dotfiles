...
-- TODO: Add toggle
-- vim.keymap.set('n', '<leader>qd', vim.diagnostic.enable(not vim.diagnostic.is_enabled()), { desc = 'Toggle diagnostic' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Shortcut for searching Infos
      vim.keymap.set('n', '<leader>si', function()
        builtin.find_files { cwd = '~/Nextcloud/Library/Infos/' }
      end, { desc = '[S]earch [I]nfos' })
    end,
  },
    ...
    dependencies = {
      -- Snippet Engine & its associated nvim-cmp source
      {
        ...
        build = (function()
          ...
          -- https://github.com/L3MON4D3/LuaSnip/issues/1140
          if vim.fn.has 'win32' == 1 or vim.fn.executable 'make' == 0 or vim.loop.os_uname().sysname == "FreeBSD" then
            return
          end
  ...
  },
  {
    ...
    -- 'folke/snacks.nvim' moved to snacks.lua
    {
      -- java
